...
class AstarStrategy : public IStrategy {
 public:
   /**
    * @brief The constructor for AstarStrategy class
    * @param position Vector3 object that represents the position of the
    * AstarStrategy object.
    ...
    * simulation. 
    * @return A pointer to the new AstarStrategy object.
    **/
  AstarStrategy(Vector3 position, Vector3 destination, const IGraph* graph);

   /**
    * @brief The deconstructor for the AstarStrategy class.
    **/
  ~AstarStrategy();
